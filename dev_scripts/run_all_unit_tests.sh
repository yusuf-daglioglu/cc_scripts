...
# RESERVED STANDART EXIT CODE: 247,246,245

source "./dev_exception_handler.sh" || exit 249
source "./dev_print_utils.sh" || exit 248
source "./../src/core_shell_utils/cc_exit_code.sh" || exit 247
